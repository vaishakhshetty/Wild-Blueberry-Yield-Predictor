...
def main():
    ...
    clonesize = st.text_input('clonesize', 'input average blueberry clonesize')
    honeybee = st.text_input('honeybee', 'input honeybee density')
    bumbles = st.text_input('bumbles', 'input bumblebee density')
    andrena = st.text_input('andrena', 'input andrena bee density')
    osmia = st.text_input('osmia', 'input osmia bee density')
